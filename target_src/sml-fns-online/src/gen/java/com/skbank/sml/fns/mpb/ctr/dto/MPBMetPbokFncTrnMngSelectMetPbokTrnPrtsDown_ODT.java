...
/**
 * 모임통장.거래.내역.다운로드.컨트롤러.출력.IO
 */
@XmlType(propOrder={
	"fileNm", "fileDir", "filePath", "fileSize", "fileData"
}, name="MPBMetPbokFncTrnMngSelectMetPbokTrnPrtsDown_ODT")
@XmlRootElement(name="MPBMetPbokFncTrnMngSelectMetPbokTrnPrtsDown_ODT")
@BxmCategory(logicalName="모임통장.거래.내역.다운로드.컨트롤러.출력.IO", description="모임통장.거래.내역.다운로드.컨트롤러.출력.IO") 
public class MPBMetPbokFncTrnMngSelectMetPbokTrnPrtsDown_ODT implements IOmmObject, Predictable, FieldInfo
{
	private static final long serialVersionUID= -1678563280L;
	...
	@Override
	public MPBMetPbokFncTrnMngSelectMetPbokTrnPrtsDown_ODT clone(){
		try{
			MPBMetPbokFncTrnMngSelectMetPbokTrnPrtsDown_ODT object= (MPBMetPbokFncTrnMngSelectMetPbokTrnPrtsDown_ODT)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final MPBMetPbokFncTrnMngSelectMetPbokTrnPrtsDown_ODT other= (MPBMetPbokFncTrnMngSelectMetPbokTrnPrtsDown_ODT)obj;
		{
	...
	public String toString() {
		...
		sb.append("\n[").append(MPBMetPbokFncTrnMngSelectMetPbokTrnPrtsDown_ODT.class.getName()).append(":\n");
		sb.append("\tfileNm: ");
