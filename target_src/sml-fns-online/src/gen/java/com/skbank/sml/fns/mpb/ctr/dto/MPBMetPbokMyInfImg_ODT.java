...
}, name="MPBMetPbokMyInfImg_ODT")
@XmlRootElement(name="MPBMetPbokMyInfImg_ODT")
@BxmCategory(logicalName="모임통장.나의정보.이미지.컨트롤러.출력.IO", description="") 
public class MPBMetPbokMyInfImg_ODT implements IOmmObject, Predictable, FieldInfo
{
	private static final long serialVersionUID= -1314564748L;
	...
	@Override
	public MPBMetPbokMyInfImg_ODT clone(){
		try{
			MPBMetPbokMyInfImg_ODT object= (MPBMetPbokMyInfImg_ODT)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final MPBMetPbokMyInfImg_ODT other= (MPBMetPbokMyInfImg_ODT)obj;
		{
	...
	public String toString() {
		...
		sb.append("\n[").append(MPBMetPbokMyInfImg_ODT.class.getName()).append(":\n");
		sb.append("\tfileNm: ");
