...
}, name="INBNtfbxPushEtcEstInsertMyNtfc_IDT")
@XmlRootElement(name="INBNtfbxPushEtcEstInsertMyNtfc_IDT")
@BxmCategory(logicalName="나만의알림등록IDT", description="나만의알림등록IDT") 
public class INBNtfbxPushEtcEstInsertMyNtfc_IDT implements IOmmObject, Predictable, FieldInfo
{
	private static final long serialVersionUID= -1704280316L;
	...
	@Override
	public INBNtfbxPushEtcEstInsertMyNtfc_IDT clone(){
		try{
			INBNtfbxPushEtcEstInsertMyNtfc_IDT object= (INBNtfbxPushEtcEstInsertMyNtfc_IDT)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final INBNtfbxPushEtcEstInsertMyNtfc_IDT other= (INBNtfbxPushEtcEstInsertMyNtfc_IDT)obj;
		{
	...
	public String toString() {
		...
		sb.append("\n[").append(INBNtfbxPushEtcEstInsertMyNtfc_IDT.class.getName()).append(":\n");
		sb.append("\titcsno: ");
