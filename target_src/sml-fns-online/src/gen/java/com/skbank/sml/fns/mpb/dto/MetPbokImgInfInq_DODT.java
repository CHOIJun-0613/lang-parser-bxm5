...
}, name="MetPbokImgInfInq_DODT")
@XmlRootElement(name="MetPbokImgInfInq_DODT")
@BxmCategory(logicalName="모임통장.이미지.정보.조회.입력.IO", description="") 
public class MetPbokImgInfInq_DODT implements IOmmObject, Predictable, FieldInfo
{
	private static final long serialVersionUID= 104656456L;
	...
	@Override
	public MetPbokImgInfInq_DODT clone(){
		try{
			MetPbokImgInfInq_DODT object= (MetPbokImgInfInq_DODT)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final MetPbokImgInfInq_DODT other= (MetPbokImgInfInq_DODT)obj;
		{
	...
	public String toString() {
		...
		sb.append("\n[").append(MetPbokImgInfInq_DODT.class.getName()).append(":\n");
		sb.append("\tfileNm: ");
