...
@XmlType(propOrder={
	...
	, "rcvAcno", "wdrPbokMrk", "rcvPbokMrk", "mretTsYn", "notiTmpTyp", "rgsDh", "checked"
}, name="INBNtfbxPushEtcEstUpdateMyNtfcDtl_IDT")
@XmlRootElement(name="INBNtfbxPushEtcEstUpdateMyNtfcDtl_IDT")
@BxmCategory(logicalName="나만의알림상세변경IDT", description="나만의알림상세변경IDT") 
public class INBNtfbxPushEtcEstUpdateMyNtfcDtl_IDT implements IOmmObject, Predictable, FieldInfo
{
	private static final long serialVersionUID= -937852900L;
	...
	@BxmOmm_Field(length=1, decimal=0, description="선택된알림", align="left", fill="")
	...
	@Override
	public INBNtfbxPushEtcEstUpdateMyNtfcDtl_IDT clone(){
		try{
			INBNtfbxPushEtcEstUpdateMyNtfcDtl_IDT object= (INBNtfbxPushEtcEstUpdateMyNtfcDtl_IDT)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final INBNtfbxPushEtcEstUpdateMyNtfcDtl_IDT other= (INBNtfbxPushEtcEstUpdateMyNtfcDtl_IDT)obj;
		{
	...
	public String toString() {
		...
		sb.append("\n[").append(INBNtfbxPushEtcEstUpdateMyNtfcDtl_IDT.class.getName()).append(":\n");
		sb.append("\titcsno: ");
